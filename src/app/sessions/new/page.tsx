    ...
    const payload: SessionRequest = {
      ...
      exercises: selectedExercises.map((ex, exIndex) => ({
        ...
        sets: ex.sets.map((s) => ({
          ...
          notes: s.isCompleted ? "Completed" : null, // 完成狀態標記
        })),
      })),
    };
  ...
  return (
    <main className="container" style={{ paddingBottom: "100px", position: "relative" }}>
      ...
      <header style={{ marginBottom: "2rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <h1 style={{ fontSize: "1.25rem", fontWeight: "800", color: "var(--foreground)", letterSpacing: "-0.025em" }}>記錄新訓練</h1>
        <button
      ...
      {showSuccessModal && (
        <div style={{
          ...
          <div style={{ textAlign: "center", maxWidth: "300px" }}>
            ...
            <h2 style={{ fontSize: "1.5rem", fontWeight: "900", marginBottom: "0.5rem" }}>訓練完成！</h2>
